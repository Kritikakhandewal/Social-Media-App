...
val viewHolder=  PostViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_post,parent,false))
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: Post) {
        ...
        Glide.with(holder.userImage.context).load(model.createdBy.imageUrl).circleCrop().into(holder.userImage)//loading image of user through imageurl
        holder.likeCount.text =model.likedBy.size.toString()//size of how many user liked it
